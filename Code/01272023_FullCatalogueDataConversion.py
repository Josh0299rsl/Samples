...
tavg_velocities_p57_3172022 = np.loadtxt(timeavg_data_directory_location+'Full3172022_ShotsandVelocities_P5P7.txt', skiprows=1, unpack=True).T
...
# This NewProbe2 below was some probe David inserted into the BMX for some reason - Check with him.
pos = data923.create_group("NewProbe2")
raw = pos.create_group("raw")
