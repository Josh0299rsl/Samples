...
"""
What happens if I pass the voltage traces through a 5kHz low-pass digital filter, in order to determine the 'steady-state' voltage?
Barnes et al paper mentions this is a way to determine the 'steady-state' voltage.
"""
